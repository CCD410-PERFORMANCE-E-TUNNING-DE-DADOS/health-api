...
* The original package name 'com.healthapi.health-api' is invalid and this project uses 'com.healthapi.health_api' instead.
...
* [Spring Data for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.2/reference/data/nosql.html#data.nosql.cassandra)
